...
export default function Sidebar() {
  ...
  return (
    <aside className="w-64 bg-white dark:bg-gray-900 border-r dark:border-gray-700 p-4 overflow-y-auto h-screen">
      <div className="flex items-center mb-8">
        <span className="text-2xl font-semibold text-gray-900 dark:text-white ml-2">
          eGrocer
        </span>
      </div>
